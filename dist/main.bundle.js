...
function _readFileAsArrayBuffer() {
  _readFileAsArrayBuffer = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(filePath) {
    var data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          data = _context.sent;
          return _context.abrupt("return", new Uint8Array(data).buffer);
        case 4:
        case "end":
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var _require = __webpack_require__(/*! ./fileHandler */ "./src/fileHandler.js"),
  readFileAsArrayBuffer = _require.readFileAsArrayBuffer;
var _require2 = __webpack_require__(/*! ./zipHandler */ "./src/zipHandler.js"),
  decompressZIP = _require2.decompressZIP;
var _require3 = __webpack_require__(/*! ./xmlParser */ "./src/xmlParser.js"),
  parseXMLWithSAX = _require3.parseXMLWithSAX;
...
function fxlsx(_x) {
  return _fxlsx.apply(this, arguments);
}
function _fxlsx() {
  _fxlsx = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(filePath) {
    var arrayBuffer, zipEntries, sharedStringsFile, sharedStrings, sharedStringsXML, sheetFile, xmlString, sheetData;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
        ...
        case 3:
          ...
          _context.next = 6;
          return decompressZIP(arrayBuffer);
        case 6:
          zipEntries = _context.sent;
          // Find and load shared strings
          sharedStringsFile = zipEntries.find(function (entry) {
          ...
          _context.next = 12;
          return sharedStringsFile.content.async("string");
        case 12:
          sharedStringsXML = _context.sent;
        ...
        case 14:
          ...
          sheetFile = zipEntries.find(function (entry) {
            return entry.name === 'xl/worksheets/sheet1.xml';
          });
          if (!sheetFile) {
            _context.next = 23;
            break;
          ...
          _context.next = 18;
          return sheetFile.content.async("string");
        case 18:
          xmlString = _context.sent;
          sheetData = parseXMLWithSAX(xmlString, sharedStrings); // Pass sharedStrings for content lookup
...
function parseXMLWithSAX(xmlString, sharedStrings) {
  ...
  var inSheetData = false; // Flag to indicate if we're in <sheetData>
  ...
  parser.onopentag = function (node) {
    ...
    if (inSheetData) {
      if (node.name === 'row') {
        ...
        var cellType = node.attributes.t;
        currentCell = {
          isShared: cellType === 's',
          value: ''
        };
  ...
  parser.onclosetag = function (tagName) {
    if (tagName === 'c' && currentCell) {
      ...
      var cellValue = currentCell.isShared ? sharedStrings[parseInt(currentCell.value, 10)] || "" : currentCell.value;
...
module.exports = {
  parseXMLWithSAX: parseXMLWithSAX
};
...
function decompressZIP(_x) {
  return _decompressZIP.apply(this, arguments);
}
function _decompressZIP() {
  _decompressZIP = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(arrayBuffer) {
    var zip, zipEntries;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 2:
          ...
          zip.forEach(function (relativePath, file) {
            ...
            zipEntries.push({
              name: relativePath,
              content: file
            }); // Push file itself as content
          });
          return _context.abrupt("return", zipEntries);
        case 6:
        case "end":
          return _context.stop();
      }
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkjxls"] = self["webpackChunkjxls"] || [];
